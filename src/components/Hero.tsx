      ...
      <div className="container relative z-10 mx-auto px-4 py-20 text-center">
        <div className="mx-auto max-w-4xl space-y-8">
          ...
          <h1 className="text-5xl md:text-7xl font-bold leading-tight flex items-center justify-center gap-3 md:gap-4 flex-wrap">
            ...
            <span className="gradient-text inline-flex items-center gap-2 md:gap-3">
              ...
              <img
                src={logoBox}
                alt="Коробка"
                className="mt-2 w-12 h-12 md:w-16 md:h-16 inline-block"
              />
            </span>
          </h1>
          ...
          <p className="text-xl md:text-2xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
            ChatGPT, ИИ-фотосессии, видео-генерация, автоматизация и
            монетизация— всё, что нужно, чтобы зарабатывать и оставаться
            востребованным в эпоху ИИ в одной Telegram-подписке.
          </p>
          ...
          <div className="flex flex-col items-center gap-4 pt-4">
            ...
            <p className="text-sm text-muted-foreground">
              Один Telegram-доступ. Десятки практических курсов. Новые уроки
              каждую неделю.
            </p>
          </div>
        </div>
