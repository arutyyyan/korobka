...
const Courses = () => {
  const { openEnrollment, enrollmentDialog, isEnrolled, enrollmentLoading } =
    useCourseEnrollment();
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-600 max-w-md mx-auto">
              Постоянно обновляемые практические курсы по всем нужным нейросетям
              и ИИ-инструментам
            </p>
          </div>
          ...
          <div className="mb-16">
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
              {sortedCourses.map((course, index) => {
                ...
                const isEnrollDisabled = Boolean(
                  enrollmentLoading && !enrolled
                );
                return (
                  <div
                    key={index}
                                ...
                                <div className="flex h-full flex-col">
                                  ...
                                  <div className="flex-1 overflow-y-auto p-5 space-y-5">
                                    ...
                                    <div className="pt-2">
                                      ...
                                      <div className="pl-5 space-y-2 text-base leading-relaxed text-gray-800 list-decimal">
                                ...
                                <div className="flex h-full flex-col">
                                  ...
                                  <div className="flex-1 overflow-y-auto p-6 md:p-8 space-y-6">
                                    ...
                                    <div className="pt-2">
                                      ...
                                      <div className="pl-5 space-y-2 text-base md:text-lg leading-relaxed text-gray-800 list-decimal">
                                        {course.program?.map((item, idx) => (
                                          <p key={idx}>{item}</p>
                                        ))}
                                      </div>
