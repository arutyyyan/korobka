      ...
      <div className="mx-auto max-w-6xl">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-base sm:text-lg md:text-xl text-muted-foreground max-w-lg mx-auto">
            Компании сокращают людей, и активно нанимают тех, кто умеет
        ...
        <div className="grid lg:grid-cols-2 gap-12 mb-16">
                  ...
                  <div className="flex items-start gap-4 mb-6 flex-col">
                    ...
                    <div className="flex-1">
                      <h3 className="text-xl sm:text-2xl font-bold text-gray-900 mb-2">
                        Пока ты просто смотришь рилсы про ИИ
                      </h3>
                      <p className="text-gray-600">
                        Слышишь про новые нейросети, но не пробуешь их на
                        практике
                      </p>
                    </div>
                  </div>
          ...
          <div className="space-y-8">
            <div className="relative">
              {/* Solution Card */}
              <div
                className="rounded-3xl p-6 border border-primary/20 relative overflow-hidden"
                style={{
                ...
                <div className="relative z-10">
                  ...
                  <div className="mt-6 grid gap-4">
                    {[
                      ...
                      <div
                        key={index}
                        className="flex items-center border-primary/30 gap-4 py-4 px-5 bg-[#fafafa] rounded-2xl border border-gray-100 "
                      >
                        <div
                          className={`w-12 h-12 ${item.color} rounded-xl flex items-center justify-center flex-shrink-0 overflow-hidden`}
                        >
                          <img
                            src={item.icon}
                            alt={item.title}
                ...
                <div className="order-1 lg:order-2 text-center lg:text-left">
                  <div className="mb-6">
                    ...
                    <h3 className="text-2xl sm:text-3xl md:text-4xl font-bold text-white mb-4">
                      Через год <span className="text-white/90">ИИ-опыт</span>{" "}
                      будет в каждом резюме
                    </h3>
                    <p className="text-lg text-white/80 mb-6">
                      И вопрос будет не <em>«зачем учить ИИ»</em>, а{" "}
                      <em className="text-white font-semibold">
                        «почему ты до сих пор не умеешь?»
                      </em>
                    </p>
                  </div>
