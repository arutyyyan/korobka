      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-gray-600 max-w-xl mx-auto mb-8">
            Посмотри реальные цены на ИИ-курсы в других школах и пойми,
            насколько выгодна Коробка
          </p>
        </div>
          ...
          <div className="bg-white rounded-3xl p-8 pb-0 border border-gray-200">
            <div className="text-center mb-6">
              <h3 className="text-2xl font-bold text-gray-900 mb-4">
                Обычный курс <br /> по нейросетям
              </h3>

              {/* Price Display */}
              <div className="mb-4">
                <div className="md:text-6xl text-5xl font-black text-[#D24424] mb-1">
                  300-500€
                </div>
          ...
          <div className="bg-primary rounded-3xl p-8 text-white overflow-hidden">
            <div className="text-center mb-6">
              <h3 className="text-2xl font-bold mb-4">
                Коробка <br /> AI-навыков
              </h3>

              {/* Price Display */}
              <div className="mb-4">
                <div className="md:text-6xl text-5xl font-black mb-1">
                  20€/мес
                </div>
            ...
            <button
              onClick={handleClick}
              className="mb-8 flex items-center justify-center  gap-2 bg-white text-primary  font-semibold px-10 py-5 rounded-2xl transition-all text-xl transform w-full"
            >
              Начать за 20€/мес
            </button>
